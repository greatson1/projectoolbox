...
const FEATURES = [
  ...
  { icon: Zap, title: "Any Methodology, One Platform", desc: "Traditional, Scrum, Waterfall, SAFe, Kanban, or Hybrid — your agent adapts its governance to match how you work." },
];
