...
AUTONOMY LEVEL: L${agent.autonomyLevel} (${["", "Advisor", "Co-pilot", "Autonomous"][agent.autonomyLevel]})
...
- ARTEFACT APPROVAL: You cannot approve artefacts. Only check the actual status from the data above. If an artefact is DRAFT or PENDING_REVIEW, it is NOT approved — never claim otherwise.
