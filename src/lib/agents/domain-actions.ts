...
const CAPABILITY_MATRIX: Record<string, [CapabilityAction, CapabilityAction, CapabilityAction, CapabilityAction]> = {
  // [L1 Advisor, L2 Co-pilot, L3 Autonomous, L4 Strategic]
  "project_charter": ["Draft", "HITL", "Auto", "Auto"],
  "communications_plan": ["Draft", "HITL", "Auto", "Auto"],
  "risk_register_initial": ["Draft", "HITL", "Auto", "Auto"],
  "task_status_update": ["HITL", "Auto", "Auto", "Auto"],
  "task_reassign_same_role": ["HITL", "Auto", "Auto", "Auto"],
  "task_reschedule_noncritical": ["HITL", "HITL", "Auto", "Auto"],
  "task_reschedule_critical": ["HITL", "HITL", "HITL", "Auto"],
  "sprint_planning": ["HITL", "Auto", "Auto", "Auto"],
  "sprint_retrospective": ["HITL", "Auto", "Auto", "Auto"],
  "log_new_risk": ["Draft", "Auto", "Auto", "Auto"],
  "update_risk_score": ["HITL", "Auto", "Auto", "Auto"],
  "risk_mitigation_under_5k": ["HITL", "HITL", "Auto", "Auto"],
  "risk_mitigation_over_5k": ["HITL", "HITL", "HITL", "Auto"],
  "raise_change_request": ["HITL", "Auto", "Auto", "Auto"],
  "approve_change_request": ["HITL", "HITL", "HITL", "HITL"],
  "budget_realloc_under_10pct": ["HITL", "HITL", "Auto", "Auto"],
  "budget_realloc_over_10pct": ["HITL", "HITL", "HITL", "Auto"],
  "status_report_generate": ["Draft", "Auto", "Auto", "Auto"],
  "status_report_distribute": ["HITL", "HITL", "Auto", "Auto"],
  "executive_communication": ["Draft", "HITL", "HITL", "Auto"],
  "meeting_scheduling": ["HITL", "HITL", "Auto", "Auto"],
  "phase_gate": ["HITL", "HITL", "HITL", "HITL"],
  "exception_report": ["HITL", "HITL", "HITL", "HITL"],
  "pestle_scan": ["Draft", "Auto", "Auto", "Auto"],
  "evm_calculation": ["Auto", "Auto", "Auto", "Auto"],
  ...
  "stakeholder_gap_detection": ["HITL", "Auto", "Auto", "Auto"],
  "influence_interest_mapping": ["Auto", "Auto", "Auto", "Auto"],
  "first_contact_stakeholder": ["HITL", "HITL", "Auto", "Auto"],
  "stakeholder_landscape_monitoring": ["HITL", "Auto", "Auto", "Auto"],
  // Supplier/Procurement research
  "supplier_market_research": ["Auto", "Auto", "Auto", "Auto"],
  "supplier_evaluation_matrix": ["Auto", "Auto", "Auto", "Auto"],
  "rfp_rfq_dispatch": ["HITL", "HITL", "Auto", "Auto"],
  "supplier_proposal_analysis": ["HITL", "Auto", "Auto", "Auto"],
  "supplier_selection_recommendation": ["HITL", "HITL", "HITL", "HITL"],
  ...
  "market_price_monitoring": ["HITL", "Auto", "Auto", "Auto"],
  // Contracts & documents
  "contract_sow_nda_creation": ["Draft", "HITL", "Auto", "Auto"],
  "esignature_workflow": ["HITL", "HITL", "HITL", "HITL"],
  "internal_document_signing": ["HITL", "HITL", "Auto", "Auto"],
  "signature_tracking_chasing": ["HITL", "Auto", "Auto", "Auto"],
  "document_version_control": ["HITL", "Auto", "Auto", "Auto"],
  // Purchase Orders & invoicing
  "raise_purchase_order": ["HITL", "HITL", "HITL", "HITL"],
  "send_po_to_supplier": ["HITL", "HITL", "Auto", "Auto"],
  "po_acknowledgement_matching": ["HITL", "Auto", "Auto", "Auto"],
  "invoice_three_way_matching": ["HITL", "Auto", "Auto", "Auto"],
  // Vendor communications
  "routine_vendor_updates": ["HITL", "HITL", "Auto", "Auto"],
  "commercial_commitment_comms": ["HITL", "HITL", "HITL", "HITL"],
  "formal_notices_breach": ["HITL", "HITL", "HITL", "HITL"],
  "inbound_vendor_email_reply": ["HITL", "HITL", "Auto", "Auto"],
  // Resource/contractor management
  "external_resource_research": ["Auto", "Auto", "Auto", "Auto"],
  "role_brief_job_spec": ["HITL", "HITL", "HITL", "HITL"],
  "cv_screening_interview_scheduling": ["HITL", "Auto", "Auto", "Auto"],
  "contractor_onboarding": ["HITL", "Auto", "Auto", "Auto"],
  "contractor_timesheet_tracking": ["HITL", "Auto", "Auto", "Auto"],
};
...
export function getCapabilityAction(capability: string, autonomyLevel: number): CapabilityAction {
  ...
  const idx = Math.max(0, Math.min(3, autonomyLevel - 1));
  return matrix[idx];
}
