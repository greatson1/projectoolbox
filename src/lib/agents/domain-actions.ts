...
const CAPABILITY_MATRIX: Record<string, [CapabilityAction, CapabilityAction, CapabilityAction, CapabilityAction, CapabilityAction]> = {
  // [L1, L2, L3, L4, L5]
  "project_charter": ["—", "Draft", "Auto", "Auto", "Auto"],
  "communications_plan": ["—", "Draft", "HITL", "Auto", "Auto"],
  "risk_register_initial": ["—", "Draft", "Auto", "Auto", "Auto"],
  "task_status_update": ["—", "—", "Auto", "Auto", "Auto"],
  "task_reassign_same_role": ["—", "—", "Auto", "Auto", "Auto"],
  "task_reschedule_noncritical": ["—", "HITL", "HITL", "Auto", "Auto"],
  "task_reschedule_critical": ["—", "HITL", "HITL", "HITL", "Auto"],
  "sprint_planning": ["—", "—", "Auto", "Auto", "Auto"],
  "sprint_retrospective": ["—", "—", "Auto", "Auto", "Auto"],
  "log_new_risk": ["—", "Draft", "Auto", "Auto", "Auto"],
  "update_risk_score": ["—", "—", "Auto", "Auto", "Auto"],
  "risk_mitigation_under_5k": ["—", "—", "HITL", "Auto", "Auto"],
  "risk_mitigation_over_5k": ["—", "—", "HITL", "HITL", "Auto"],
  "raise_change_request": ["—", "—", "Auto", "Auto", "Auto"],
  "approve_change_request": ["HITL", "HITL", "HITL", "HITL", "HITL"],
  "budget_realloc_under_10pct": ["—", "—", "HITL", "Auto", "Auto"],
  "budget_realloc_over_10pct": ["—", "—", "HITL", "HITL", "Auto"],
  "status_report_generate": ["—", "Draft", "Auto", "Auto", "Auto"],
  "status_report_distribute": ["—", "—", "HITL", "Auto", "Auto"],
  "executive_communication": ["—", "Draft", "HITL", "HITL", "Auto"],
  "meeting_scheduling": ["—", "—", "HITL", "Auto", "Auto"],
  "phase_gate": ["HITL", "HITL", "HITL", "HITL", "HITL"],
  "exception_report": ["HITL", "HITL", "HITL", "HITL", "HITL"],
...
export function getCapabilityAction(capability: string, autonomyLevel: number): CapabilityAction {
  ...
  const idx = Math.max(0, Math.min(4, autonomyLevel - 1));
  return matrix[idx];
}
