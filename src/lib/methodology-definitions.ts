...
const WATERFALL: MethodologyDefinition = {
  ...
  phases: [
    {
      name: "Requirements",
      description: "Gather, analyse, and document all requirements; produce feasibility study",
      color: "#6366F1",
      artefacts: [
      ...
      gate: {
        ...
        criteria: "Requirements signed off by stakeholders",
        preRequisites: [
          { description: "Requirements complete and reviewed", category: "review", isMandatory: true, requiresHumanApproval: true },
          { description: "Stakeholder sign-off obtained", category: "sign_off", isMandatory: true, requiresHumanApproval: true },
        ],
      },
    },
    {
      name: "Design",
      description: "Produce system and detailed design documents, architecture specification",
      color: "#8B5CF6",
      artefacts: [
        { name: "Design Document", required: true, aiGeneratable: true },
        { name: "Architecture Specification", required: true, aiGeneratable: true },
      ],
      gate: {
        name: "Design Approval",
        criteria: "Design approved by technical authority",
        preRequisites: [
          { description: "Design document reviewed", category: "review", isMandatory: true, requiresHumanApproval: true },
          { description: "Architecture approved", category: "sign_off", isMandatory: true, requiresHumanApproval: true },
        ],
      },
    },
    {
